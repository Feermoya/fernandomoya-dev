...
description: Sitio web para Giacomelli Seguros, productor de seguros en Mendoza y Zona Cuyo, pensado para que el visitante entienda coberturas, compare opciones y contacte por WhatsApp sin fricción. El foco estuvo en asesoramiento claro, trayectoria de la familia y acompañamiento ante siniestros.
...
Se estructuró el contenido en bloques que siguen el recorrido del visitante: propuesta de valor, servicios destacados, revisión de pólizas, soluciones para empresas, aseguradoras con las que trabajan y acompañamiento ante siniestros. El desarrollo en Astro prioriza carga rápida, SEO local y datos estructurados para el negocio de seguros.

Cada cobertura tiene su página con contexto, beneficios y llamados a la acción hacia WhatsApp. La home concentra lo esencial para quien llega sin saber por dónde empezar; las secciones de empresas y minería agrupan casos más específicos sin mezclarlos con el flujo general.

El diseño responsive adapta hero, tarjetas de servicio y CTAs para pantallas chicas, con barra de contacto visible en mobile. Los enlaces a WhatsApp incluyen texto prearmado según la intención —cotizar, revisar póliza, consultar siniestro— para reducir fricción al escribir.

## Decisiones de diseño

La jerarquía visual separa confianza —años de trayectoria, tono cercano— de utilidad —qué cubre cada seguro y cómo avanzar— para que no compitan. Se evitó saturar con comparativas agresivas: el mensaje central es asesoramiento y acompañamiento, no solo precio.
...
El footer incluye matrícula SSN y referencia al organismo de control, requisito del sector que también refuerza transparencia.
