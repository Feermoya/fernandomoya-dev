...
Como trabajo propio, también servía de espacio para probar contenidos y presentación de catálogo con criterios que después aplico en proyectos de clientes.

## Objetivo

- Mostrar el catálogo de vinos con fichas claras y jerarquía visual ordenada.
- Simplificar el flujo hacia el carrito y el cierre del pedido.
- Mantener la marca presente sin saturar con efectos.
- Que la experiencia en mobile sea tan usable como en escritorio.
- Separar contenidos de marca o storytelling de la parte transaccional cuando haga falta.
...
La información se ordenó para que el vino sea protagonista: fondos sobrios, espacio en blanco y tipografía que no compita con las etiquetas. La navegación del catálogo evita menús profundos: categorías o filtros simples cuando aplican.
